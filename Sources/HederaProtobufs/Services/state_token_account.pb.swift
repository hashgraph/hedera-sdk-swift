...
public struct Proto_Account {
  ...
  #if !swift(>=4.1)
    public static func ==(lhs: Proto_Account.OneOf_StakedID, rhs: Proto_Account.OneOf_StakedID) -> Bool {
...
public struct Proto_AccountApprovalForAllAllowance {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Proto_AccountFungibleTokenAllowance {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Proto_AccountCryptoAllowance {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Proto_Account: @unchecked Sendable {}
extension Proto_Account.OneOf_StakedID: @unchecked Sendable {}
extension Proto_AccountApprovalForAllAllowance: @unchecked Sendable {}
extension Proto_AccountFungibleTokenAllowance: @unchecked Sendable {}
extension Proto_AccountCryptoAllowance: @unchecked Sendable {}
